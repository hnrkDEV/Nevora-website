...
export default function Home() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-32 px-6 md:px-20 text-gray-100 z-20 -mt-32">
      <motion.h2
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-10 w-full max-w-5xl text-center mb-28">
        {[
